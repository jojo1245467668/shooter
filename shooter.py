...
# Використання у коді
path_music = "assets\\music\\fon_misic.ogg"
shut_sound = "assets\\music\\shoot.ogg"
...
img_hero = "assets\\pictures\\ship.png"  # герой
img_bullet = "assets\\pictures\\rocket_red.png"  # куля
img_enemy = "assets\\pictures\\robot.png"  # ворог
...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet(
            img_bullet, self.rect.centerx, self.rect.top, 30, 50, -15
        )
        bullets.add(bullet)
